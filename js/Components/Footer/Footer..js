            ...
            <div className="footer__container">
                <div className="footer__start">
                    ...
                    <h1
                        ...
                        onClick={() => window.open(`https://www.linkedin.com/in/amisha-saxena-9a9968231/`, "_blank")}
                    >
                        By <span className="footer__link">Amisha Saxena</span>
                    </h1>
                </div>
                ...
                <div
                    ...
                    onClick={() =>
                        window.open(`https://github.com/Amisha1808`, "_blank")
                    }
                >
